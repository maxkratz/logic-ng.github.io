...
- [Formula reader](https://github.com/logic-ng/parser/blob/master/src/main/java/org/logicng/io/readers/FormulaReader.java) for reading files in LogicNG syntax from a file.
